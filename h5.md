...
- The Vagrantfile is commented well so the rest you can figure out from there!
...
``` 
**Side note:** the hashing is a requirement for this to work!
...
- Salt Essentials (book) by Craig Sebenik & Thomas Hatch (2015)
- [Salt bootsrap](<https://docs.saltproject.io/en/3006/topics/tutorials/salt_bootstrap.html>)
- [Salt bootstrap download](<https://github.com/saltstack/salt-bootstrap?tab=readme-ov-file#testing-in-vagrant>)
- [Salt documentation](<https://docs.saltproject.io/en/latest/contents.html>)
- [Salt pillars](<https://docs.saltproject.io/salt/user-guide/en/latest/topics/pillar.html>)
- [MySQL preseed](<https://terokarvinen.com/2018/mysql-automatic-install-with-salt-preseed-database-root-password/>)
- [MySQL state](<https://www.digitalocean.com/community/tutorials/saltstack-infrastructure-creating-salt-states-for-mysql-database-servers>)
- [Nginx Salt States](<https://www.digitalocean.com/community/tutorials/saltstack-infrastructure-creating-salt-states-for-nginx-web-servers>)
- [Nginx VirtualHost](<https://www.digitalocean.com/community/tutorials/how-to-set-up-nginx-server-blocks-virtual-hosts-on-ubuntu-16-04>)
- [Apache VirtualHost](<https://httpd.apache.org/docs/2.4/vhosts/examples.html>)
