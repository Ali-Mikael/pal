...
The environment at the moment contains in essence
- A database server running Mariadb / Can be swapped for MySQL
- A webserver running Apache / Can be swapped for Nginx
...
Apparently index.html file was updated and that service is runnning. <br> 
...
### Using pillars again for the password
**database.sls:** 
```
