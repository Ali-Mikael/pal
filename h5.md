...
We have a scalable structure which can easily by expanded and modified to fit ones needs. Having a clear and consistent structure makes it easy to configure different minions for different purposes. <br> 

The environment contains in essence (at the moment)
- A database server
- A web server 
